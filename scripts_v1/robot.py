...
def set_initial_position(rtde_c):
    ...
    initial_position = [1.7239642143249512, -2.054093977014059, -0.8874862194061279, -1.7807942829527796, 1.5661470890045166, 1.714949131011963]

    # Move the robot to the initial position using a linear movement
    rtde_c.moveJ(initial_position)  # Use moveJ for joint space movement
